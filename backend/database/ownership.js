...
const ENTITIES = Object.freeze({
    ...
    live_interview_session: maria('live_interview_session', 'live_interview_sessions', 'Server-authoritative, owner-scoped adaptive interview session state with optimistic revision guards.'),
...
const ALIASES = Object.freeze({
    ...
    resumes: 'resume', live_interview_sessions: 'live_interview_session', public_resumes: 'resume_publication', canonical_documents: 'canonical_document', portfolios: 'portfolio',
