...
function validateMembership(record, principalId) {
  ...
  return {
    ...
    canonicalPrincipalId: record.canonicalPrincipalId ? assertUuid(record.canonicalPrincipalId, 'Canonical principal identifier') : canonicalPrincipalId(principalId),
