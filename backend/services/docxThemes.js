...
const THEMES = Object.freeze({
  ...
  Cv5: theme({ name: 'Stanford Clean ATS', archetype: A.MINIMAL_ATS, primary: '#1e293b', secondary: '#0ea5e9', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.PILLS, dividerStyle: 'left-bar', density: 'standard' }),
  Cv6: theme({ name: 'Wall Street Modern', archetype: A.MINIMAL_ATS, primary: '#0f172a', secondary: '#2563eb', font: "'Inter', sans-serif", skillVariant: S.BADGES, dividerStyle: 'double-line', density: 'compact' }),
  Cv7: theme({ name: 'Sapphire Modern Split', archetype: A.MODERN_SPLIT, primary: '#1d4ed8', secondary: '#60a5fa', sidebarBg: '#eff6ff', sidebarText: '#1e3a8a', font: "'Montserrat', sans-serif", skillVariant: S.PILLS, sidebarWidth: '34%' }),
  ...
  Cv12: theme({ name: 'Oxford Academic ATS', archetype: A.MINIMAL_ATS, primary: '#1e1b4b', secondary: '#4338ca', font: "'Merriweather', serif", skillVariant: S.INLINE, dividerStyle: 'double-line', density: 'standard' }),
  ...
  Cv14: theme({ name: 'Yale Corporate ATS', archetype: A.MINIMAL_ATS, primary: '#0c2340', secondary: '#c59b27', font: "'Cinzel', 'Plus Jakarta Sans', sans-serif", skillVariant: S.BADGES, dividerStyle: 'solid-thick', density: 'standard' }),
  Cv15: theme({ name: 'MIT Technical ATS', archetype: A.MINIMAL_ATS, primary: '#8b0000', secondary: '#475569', font: "'Inter', sans-serif", skillVariant: S.BADGES, dividerStyle: 'left-bar', density: 'compact' }),
  ...
  Cv18: theme({ name: 'Princeton Minimal ATS', archetype: A.MINIMAL_ATS, primary: '#27272a', secondary: '#d97706', font: "'Georgia', serif", skillVariant: S.INLINE, dividerStyle: 'solid-thin', density: 'standard' }),
  Cv19: theme({ name: 'Zurich Financial ATS', archetype: A.MINIMAL_ATS, primary: '#004b49', secondary: '#d97706', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.BADGES, dividerStyle: 'double-line', density: 'compact' }),
  ...
  Cv22: theme({ name: 'Geneva Executive ATS', archetype: A.MINIMAL_ATS, primary: '#18181b', secondary: '#dc2626', font: "'Inter', sans-serif", skillVariant: S.PILLS, dividerStyle: 'left-bar', density: 'standard' }),
  ...
  Cv26: theme({ name: 'FullStack Dark Split', archetype: A.MODERN_SPLIT, primary: '#00e5ff', secondary: '#10b981', sidebarBg: '#090d16', sidebarText: '#f8fafc', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.BADGES, sidebarWidth: '35%' }),
  ...
  Cv30: theme({ name: 'Corporate Summit Banner', archetype: A.EXECUTIVE_BANNER, primary: '#b45309', secondary: '#f59e0b', headerBg: '#78350f', headerText: '#ffffff', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.PILLS, sidebarWidth: '35%' }),
  Cv31: theme({ name: 'Cloud Native Tech', archetype: A.TECH_GRID, primary: '#0891b2', secondary: '#0ea5e9', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.BADGES }),
  ...
  Cv34: theme({ name: 'Fintech Executive', archetype: A.EXECUTIVE_BANNER, primary: '#0b0f19', secondary: '#00e5ff', headerBg: '#0b0f19', headerText: '#ffffff', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.PILLS, sidebarWidth: '35%' }),
  ...
  Cv38: theme({ name: 'Global Legal ATS', archetype: A.MINIMAL_ATS, primary: '#0f172a', secondary: '#0284c7', font: "'Georgia', serif", skillVariant: S.INLINE, dividerStyle: 'left-bar', density: 'standard' }),
  Cv39: theme({ name: 'Product Manager Pro', archetype: A.MODERN_SPLIT, primary: '#4338ca', secondary: '#f59e0b', sidebarBg: '#fafafa', sidebarText: '#1e293b', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.PILLS, sidebarWidth: '34%' }),
  ...
  Cv44: theme({ name: 'Scandinavia Clean Compact', archetype: A.MINIMAL_ATS, primary: '#334155', secondary: '#10b981', font: "'Inter', sans-serif", skillVariant: S.DOTS, density: 'compact' }),
  ...
  Cv46: theme({ name: 'Frankfurt Finance Euro', archetype: A.COMPACT_EURO, primary: '#1e3a8a', secondary: '#0284c7', font: "'Inter', sans-serif", skillVariant: S.BADGES }),
  ...
  Cv49: theme({ name: 'Berlin Tech Compact', archetype: A.COMPACT_EURO, primary: '#18181b', secondary: '#3b82f6', font: "'Inter', sans-serif", skillVariant: S.PILLS, density: 'compact' }),
  Cv50: theme({ name: 'Executive Platinum Split', archetype: A.MODERN_SPLIT, sidebarPosition: 'right', primary: '#0f172a', secondary: '#475569', sidebarBg: '#e2e8f0', sidebarText: '#1e293b', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.BADGES, sidebarWidth: '32%' }),
  Cv51: theme({ name: 'Standard Europass Modern', archetype: A.MODERN_SPLIT, primary: '#0f4c81', secondary: '#f59e0b', sidebarBg: '#eff6ff', sidebarText: '#1e3a8a', font: "'Inter', sans-serif", skillVariant: S.DOTS, sidebarWidth: '33%' }),
});
