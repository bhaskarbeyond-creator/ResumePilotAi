...
const THEMES = Object.freeze({
  ...
  Cv18: theme({ name: "Princeton Minimal ATS", archetype: A.MINIMAL_ATS, primary: '#c2410c', secondary: '#ea580c', font: "'Georgia', serif", skillVariant: S.PILLS, headerStyle: 'accent-bracket', dividerStyle: 'left-bar', timelineStyle: 'accent-bullet', density: 'spacious' }),
