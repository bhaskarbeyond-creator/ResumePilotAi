...
const THEMES = Object.freeze({
  ...
  Cv26: theme({ name: 'FullStack Dark Split', archetype: A.MODERN_SPLIT, primary: '#0891b2', secondary: '#06b6d4', sidebarBg: '#090d16', sidebarText: '#f8fafc', font: "'Plus Jakarta Sans', sans-serif", skillVariant: S.BADGES, sidebarWidth: '34%' }),
