...
async function auditAllEndpoints() {
    console.log('====================================================');
    console.log('🤖 ENTERPRISE AI INTEGRATION ENDPOINTS AUDIT REPORT');
    console.log('====================================================\n');
    ...
    console.log(`====================================================`);
    console.log(`AUDIT SUMMARY: ${passed}/${tests.length} ENDPOINTS PASSED CLEANLY`);
    console.log(`====================================================`);
...
sftp = ssh.open_sftp()
with sftp.file('/home/u727965524/backend/scratch_audit_ai_endpoints.js', 'w') as f:
    f.write(remote_code)

node_env = 'export PATH=/home/u727965524/.local/bin:/opt/alt/alt-nodejs20/root/usr/bin:$PATH'
stdin, stdout, stderr = ssh.exec_command(f'{node_env} && cd /home/u727965524/backend && node scratch_audit_ai_endpoints.js')
print(stdout.read().decode('utf-8', errors='ignore'))
print(stderr.read().decode('utf-8', errors='ignore'))

try: sftp.remove('/home/u727965524/backend/scratch_audit_ai_endpoints.js')
