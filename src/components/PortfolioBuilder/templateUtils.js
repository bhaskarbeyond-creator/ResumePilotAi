...
import { sanitizePortfolioText, sanitizePortfolioUrl, sanitizePortfolioImageUrl } from './portfolioSanitization';

// 🔒 SECURITY: Input sanitization utilities
export const SecurityUtils = {
    sanitizeText: sanitizePortfolioText,
    sanitizeUrl: sanitizePortfolioUrl,
    sanitizeImageUrl: sanitizePortfolioImageUrl,
