    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-2xs overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="p-12 text-center text-sm text-amber-800">Queue telemetry is unavailable. No empty queue conclusion is inferred from the failed request.</div>
        ) : jobs.length === 0 ? (
          <div className="p-12 text-center text-sm text-slate-500">
