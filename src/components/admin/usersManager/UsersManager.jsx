                                    ...
                                    <table className="min-w-full divide-y divide-slate-200 text-xs">
                                        <thead className="bg-slate-50">
                                            <tr>
                                                ...
                                                <th className="px-3 py-2 text-left font-semibold text-slate-500">Merged Into</th>
                                        ...
                                        <tbody className="divide-y divide-slate-100 bg-white">
                                            {this.state.backupsList.map((backup) => (
                                                <tr key={backup.id} className="hover:bg-slate-50 transition-colors">
                                                    ...
                                                    <td className="px-3 py-3 font-mono text-slate-500">{backup.mergedIntoUserId ? `${backup.mergedIntoUserId.slice(0, 10)}...` : '—'}</td>
