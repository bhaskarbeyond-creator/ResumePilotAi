...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaGlobeAmericas, FaUserTie, FaLinkedin, FaGithub, FaBriefcase, FaGraduationCap, FaLaptopCode, FaCalendarAlt, FaBuilding, FaUniversity } from 'react-icons/fa';
            ...
            elements.push(
                <div key={index} className="experience-item">
                    ...
                    <div className="experience-content">
                        <p className="description" dangerouslySetInnerHTML={{ __html: sanitizeRichText(tempEmployments[index].description) }}></p>
                    </div>
                </div>
            );
        }
            ...
            elements.push(
                <div key={index} className="education-item">
                    ...
                    <div className="education-content">
                        <p className="description" dangerouslySetInnerHTML={{ __html: sanitizeRichText(tempEducations[index].description) }}></p>
                    </div>
                </div>
            );
        }
