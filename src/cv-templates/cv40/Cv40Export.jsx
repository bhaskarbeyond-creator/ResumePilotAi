            ...
            elements.push(
                <div key={index} className="exp-item">
                    ...
                    <div className="exp-content">
                        ...
                        <p className="exp-description">{tempEmployments[index].description}</p>
                    </div>
                </div>
            );
        }
            ...
            elements.push(
                <div key={index} className="edu-item">
                    ...
                    <div className="edu-content">
                        ...
                        <p className="edu-description">{tempEducations[index].description}</p>
                    </div>
                </div>
            );
        }
                    ...
                    <div className="left-column">
                        <section className="profile-section section">
                            ...
                            <div className="section-content">
                                <p className="profile-text">{this.props.values.summary}</p>
                            </div>
                        </section>
