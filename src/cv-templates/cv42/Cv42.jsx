...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaGlobeAmericas, FaUserAlt, FaLinkedin, FaGithub, FaBriefcase, FaGraduationCap, FaLaptopCode, FaCalendarAlt, FaQuoteLeft, FaUserTie, FaInfoCircle, FaCircle, FaRegCircle } from 'react-icons/fa';
                ...
                <div key={index} className="experience-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-description">
                            <div dangerouslySetInnerHTML={{ __html: sanitizeRichText(tempEmployments[index].description) }}></div>
                        </div>
                    </div>
                </div>
            );
            ...
            elements.push(
                <div key={index} className="education-item">
                    ...
                    <div className="item-content">
                        ...
                        <div className="item-description">
                            <div dangerouslySetInnerHTML={{ __html: sanitizeRichText(tempEducations[index].description) }}></div>
                        </div>
                    </div>
                </div>
            );
