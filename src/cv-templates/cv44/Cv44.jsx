...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaGlobeAmericas, FaUserAlt, FaLinkedin, FaGithub, FaBriefcase, FaGraduationCap, FaLaptopCode, FaCalendarAlt, FaFileAlt, FaCode, FaChevronRight, FaCircle, FaRegCircle, FaMedal, FaBuilding } from 'react-icons/fa';
            ...
            elements.push(
                <div key={index} className="experience-item">
                    ...
                    <div className="experience-content">
                        ...
                        <div className="experience-description" dangerouslySetInnerHTML={{ __html: sanitizeRichText(tempEmployments[index].description) }}></div>
                    </div>
                </div>
            );
        }
            ...
            elements.push(
                <div key={index} className="education-item">
                    ...
                    <div className="education-content">
                        ...
                        <div className="education-description" dangerouslySetInnerHTML={{ __html: sanitizeRichText(tempEducations[index].description) }}></div>
                    </div>
                </div>
            );
        }
