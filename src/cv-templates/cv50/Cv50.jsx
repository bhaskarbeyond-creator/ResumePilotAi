...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaGlobeAmericas, FaUserAlt, FaLinkedin, FaGithub, FaBriefcase, FaGraduationCap, FaTools, FaCalendarAlt, FaUser, FaQuoteRight, FaCode, FaLanguage, FaLink, FaBullseye, FaAngleRight, FaBuilding, FaUniversity } from 'react-icons/fa';
            ...
            elements.push(
                <div key={index} className="timeline-item">
                    ...
                    <div className="timeline-content">
                        ...
                        <div className="timeline-description" dangerouslySetInnerHTML={{ __html: sanitizeRichText(tempEmployments[index].description) }}></div>
                    </div>
                </div>
            );
        }
            ...
            elements.push(
                <div key={index} className="timeline-item">
                    ...
                    <div className="timeline-content">
                        ...
                        <div className="timeline-description" dangerouslySetInnerHTML={{ __html: sanitizeRichText(tempEducations[index].description) }}></div>
                    </div>
                </div>
            );
        }
