...
class Cv6 extends Component {
    ...
    returnEmployments() {
        ...
        for (let index = 0; index < (this.props.values.employments || []).length; index++) {
            ...
            elements.push(
                <div key={index} className="cv6-jobItem">
                    <div className="cv6-jobTitle">{item.jobTitle}</div>
    ...
    returnSkills() {
        ...
        for (let index = 0; index < (this.props.values.skills || []).length; index++) {
            elements.push(
                <div key={index} className="cv6-skillItem">
                    <span> {this.props.values.skills[index].name}</span>
                    <div className="cv6-ratingWrapper" style={{ border: `1px solid ${this.getPrimaryColor()}` }}>
                        <div style={{ width: (this.props.values.skills[index].rating || 75) + '%', backgroundColor: this.getPrimaryColor() }} className="cv6-rating"></div>
                    </div>
                </div>
            );
        }
    ...
    returnEducations() {
        ...
        for (let index = 0; index < (this.props.values.educations || []).length; index++) {
            ...
            elements.push(
                <div key={index} className="cv6-jobItem">
                    <div className="cv6-jobTitle">{item.degree}</div>
                    <div className="cv6-jobDate">
        ...
        return (
            <div id="resumen" className="cv6-board">
                ...
                <div className="cv6-content">
                    <div className="cv6-left" style={{ backgroundColor: secondaryBg, color: sidebarTextColor }}>
                        {/* Photo */}
                        ...
                        <div className="cv6-leftSection">
                            <div className="cv5-leftSectionContent">
                                <div className="cv5-leftSectionTitle" style={{ border: `1px solid ${this.getPrimaryColor()}` }}>
