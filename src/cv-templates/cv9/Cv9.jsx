        ...
        for (let index = 0; index < this.props.values.skills.length; index++) {
            elements.push(
                <div key={index} className="cv9-skill">
                    <div className="cv9-bullet" style={{ backgroundColor: secondaryColor }}></div>
            ...
            <div id="resumen" className="cv9-board">
                <div className="cv9-content">
                    ...
                    <div className="cv9-head">
                        <h1 className="cv9-name">
                            {this.props.values.firstname} {this.props.values.lastname}
                        </h1>
                        <span className="cv9-occupation" style={{ color: primaryColor }}>
                            {this.props.values.occupation}
                        </span>
                        <span className="cv9-address">
                    ...
                    <div className="cv-body">
                        ...
                        <div className="cv-bodySection cv9-bodySection" style={{ borderTopColor: primaryColor }}>
                            <div className="cv-bodySection-left">
                                <span style={{ color: primaryColor }}>{t('resume.personalSummary')}</span>
                            </div>
                        ...
                        <div className="cv-bodySection cv9-bodySection" style={{ borderTopColor: primaryColor }}>
                            <div className="cv-bodySection-left">
                                <span style={{ color: primaryColor }}>{t('resume.educationHistory')}</span>
                            </div>
                            <div className="cv-bodySection-right cv9-bodySection-right">
                                {/* Job Items here */}
                        ...
                        <div className="cv-bodySection cv9-bodySection" style={{ borderTopColor: primaryColor }}>
                            <div className="cv-bodySection-left">
                                <span style={{ color: primaryColor }}>{t('resume.skills')}</span>
                            </div>
                            <div className="cv-bodySection-right cv9-bodySection-right">
                        ...
                        <div className="cv-bodySection cv9-bodySection" style={{ borderTopColor: primaryColor }}>
                            <div className="cv-bodySection-left">
                                <span style={{ color: primaryColor }}>{t('resume.languages')}</span>
                            </div>
                            <div className="cv-bodySection-right cv9-bodySection-right">
                                <div className="cv9-skills">
                                    {/* Languages Here */}
