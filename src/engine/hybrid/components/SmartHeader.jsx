...
export default function SmartHeader({ values = {}, theme = {}, variant }) {
  const effectiveVariant = variant || theme.headerStyle || 'standard';
  ...
  return (
    <header
      className={`smart-header smart-header--${effectiveVariant}`}
      style={{
        ...
        {isPhotoVisible && (
          <div className="smart-header__avatar-wrap">
            <img
              src={rawPhoto}
              alt={fullName}
              className="smart-header__avatar"
              loading="eager"
              decoding="sync"
      ...
      <div className="smart-header__contacts">
        {phone && (
          <div className="smart-contact-item">
            <svg className="smart-contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
