...
export default function MinimalATSLayout({ values = {}, theme = {} }) {
  return (
    <div className="smart-layout smart-layout--minimal-ats" style={{
      '--primary': theme.primary,
      '--secondary': theme.secondary,
      fontFamily: theme.font,
    }}>
      <SmartHeader values={values} theme={theme} variant="minimal" />
