...
function Members() {
  return <EmptyPanel title="Users & teams">Tenant membership is server-authorized. Team administration is intentionally progressive: it will appear only when workspace/team policy persistence is enabled.</EmptyPanel>;
}
...
function EnterpriseConsoleInner() {
  const { enabled, loading, error, context, tenant } = useEnterpriseTenant();
