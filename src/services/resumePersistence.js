...
export async function createResumeDraft(userId, initialData = {}, { resumeId = null } = {}) {
...
export async function loadResumeDraft(userId, resumeId) {
...
export async function saveResumeDraft(userId, resumeId, resumeData, { expectedRevision = null } = {}) {
...
export async function publishResume(userId, resumeId, resumeData, { expectedRevision = null, expectedPublicationRevision = null } = {}) {
    if (!userId || !resumeId) throw new Error('A signed-in account and resume are required');
...
export async function getResumePublication(userId, resumeId) {
...
export async function unpublishResume(userId, resumeId, { expectedPublicationRevision = null } = {}) {
    if (!userId || !resumeId) throw new Error('A signed-in account and resume are required');
...
export async function deleteResumeDraft(userId, resumeId) {
    if (!userId || !resumeId) throw new Error('A signed-in account and resume are required');
