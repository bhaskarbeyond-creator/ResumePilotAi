export const DEFAULT_SECTION_ORDER = Object.freeze(['heading', 'summary', 'employment', 'education', 'skills', 'languages', 'hobbies', 'projects', 'certifications', 'achievements', 'references', 'custom']);
