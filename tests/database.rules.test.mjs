...
test('only participants can read conversations and messages', async () => {
...
test('conversation indexes are private to their owner or participant lookup', async () => {
...
test('all messaging writes are server-only, including sender overwrite attacks', async () => {
